...
//shortest legal program
	...
	void test5() throws PLPException {
		...
		List<ProcDec> v4 = v0.procedureDecs;
		assertEquals(0, v4.size());
		Statement v5 = v0.statement;
