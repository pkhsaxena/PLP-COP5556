...
class ScopeTest {
	...
	void test0() throws PLPException {
		...
		IToken v2 = v1.get(0).ident;
		assertEquals("a", String.valueOf(v2.getText()));
		Integer v3 = (Integer) v1.get(0).val;
		assertEquals(3, v3);
		int v4 = v1.get(0).getNest();
		assertEquals(0, v4);
		List<VarDec> v5 = v0.varDecs;
		assertEquals(0, v5.size());
		List<ProcDec> v6 = v0.procedureDecs;
		assertEquals(0, v6.size());
		Statement v7 = v0.statement;
	...
	void test1() throws PLPException {
		...
		List<VarDec> v2 = v0.varDecs;
		assertEquals(1, v2.size());
		assertThat("", v2.get(0), instanceOf(VarDec.class));
		IToken v3 = v2.get(0).ident;
		assertEquals("a", String.valueOf(v3.getText()));
		int v4 = v2.get(0).getNest();
		assertEquals(0, v4);
		List<ProcDec> v5 = v0.procedureDecs;
		assertEquals(0, v5.size());
		Statement v6 = v0.statement;
		...
		IToken v9 = v8.firstToken;
		assertEquals("a", String.valueOf(v9.getText()));
		int v10 = v8.getNest();
		assertEquals(0, v10);
		Declaration v11 = v8.getDec();
	...
	void test3() throws PLPException {
		...
		IToken v6 = v5.get(0).ident;
		assertEquals("p", String.valueOf(v6.getText()));
		int v7 = v5.get(0).getNest();
		assertEquals(0, v7);
		Block v8 = v5.get(0).block;
		assertThat("", v8, instanceOf(Block.class));
		List<ConstDec> v9 = v8.constDecs;
		assertEquals(0, v9.size());
		List<VarDec> v10 = v8.varDecs;
		assertEquals(0, v10.size());
		List<ProcDec> v11 = v8.procedureDecs;
		assertEquals(0, v11.size());
		Statement v12 = v8.statement;
	...
	void test4() throws PLPException {
		...
		IToken v10 = v9.get(0).ident;
		assertEquals("x", String.valueOf(v10.getText()));
		Integer v11 = (Integer) v9.get(0).val;
		assertEquals(2, v11);
		int v12 = v9.get(0).getNest();
		assertEquals(1, v12);
		List<VarDec> v13 = v8.varDecs;
		assertEquals(0, v13.size());
		List<ProcDec> v14 = v8.procedureDecs;
		assertEquals(0, v14.size());
		Statement v15 = v8.statement;
	...
	void test6() throws PLPException {
		...
		IToken v25 = v24.firstToken;
		assertEquals("p", String.valueOf(v25.getText()));
		int v26 = v24.getNest();
		assertEquals(1, v26);
		Declaration v27 = v24.getDec();
	...
	void paramTest1() throws PLPException {
		...
		List<ConstDec> v21 = v20.constDecs;
		assertEquals(0, v21.size());
		List<VarDec> v22 = v20.varDecs;
		assertEquals(0, v22.size());
		List<ProcDec> v23 = v20.procedureDecs;
		assertEquals(0, v23.size());
		Statement v24 = v20.statement;
	...
	void paramTest5() throws PLPException {
		...
		assertEquals(1, v32.getNest());
		Declaration v33 = v32.getDec();
		...
		assertEquals(1, v43.getNest());
		Declaration v44 = v43.getDec();
		IToken v45 = ((ConstDec) v44).ident;
	...
	void paramTest6() throws PLPException {
		...
		assertEquals(1, v48.getNest());
		Declaration v49 = v48.getDec();
		...
		assertEquals(1, v59.getNest());
		Declaration v60 = v59.getDec();
	...
	void paramTest8() throws PLPException {
		...
		List<ConstDec> v37 = v36.constDecs;
		assertEquals(0, v37.size());
		List<VarDec> v38 = v36.varDecs;
		assertEquals(0, v38.size());
		List<ProcDec> v39 = v36.procedureDecs;
		assertEquals(0, v39.size());
		Statement v40 = v36.statement;
		...
		assertEquals(1, v76.getNest());
		Declaration v77 = v76.getDec();
	...
	void paramTest10() throws PLPException {
		...
		Integer v24 = (Integer) v22.val;
		assertEquals(4, v24);
		assertEquals(1, v22.getNest());
		List<VarDec> v26 = v20.varDecs;
		assertEquals(0, v26.size());
		List<ProcDec> v27 = v20.procedureDecs;
		...
		List<ConstDec> v39 = v38.constDecs;
		assertEquals(0, v39.size());
		List<VarDec> v40 = v38.varDecs;
		assertEquals(0, v40.size());
		List<ProcDec> v41 = v38.procedureDecs;
		assertEquals(0, v41.size());
		Statement v42 = v38.statement;
	...
	void paramTest11() throws PLPException {
		...
		List<ProcDec> v29 = v26.procedureDecs;
		assertEquals(0, v29.size());
		Statement v30 = v26.statement;
		...
		List<ConstDec> v41 = v40.constDecs;
		assertEquals(0, v41.size());
		List<VarDec> v42 = v40.varDecs;
		assertEquals(0, v42.size());
		List<ProcDec> v43 = v40.procedureDecs;
		assertEquals(0, v43.size());
		Statement v44 = v40.statement;
	...
	void paramTest12() throws PLPException {
		...
		List<ProcDec> v33 = v30.procedureDecs;
		assertEquals(0, v33.size());
		Statement v34 = v30.statement;
		...
		assertEquals(2, v42.getNest());
		Declaration v43 = v42.getDec();
		IToken v44 = ((ConstDec) v43).ident;
		...
		assertEquals("c", String.valueOf(v53.firstToken.getText()));
		assertEquals(2, v53.getNest());
		Declaration v54 = v53.getDec();
		IToken v55 = ((ConstDec) v54).ident;
		assertEquals("c", String.valueOf(v55.getText()));
		String v56 = (String) ((ConstDec) v54).val;
		assertEquals("a", v56);
		...
		assertEquals(1, v77.getNest());
		Declaration v78 = v77.getDec();
		...
		assertEquals(1, v88.getNest());
		Declaration v89 = v88.getDec();
	...
	void paramTest14() throws PLPException {
		...
		assertEquals(2, v54.getNest());
		Declaration v55 = v54.getDec();
		...
		assertEquals(1, v82.getNest());
		Declaration v83 = v82.getDec();
		IToken v84 = ((VarDec) v83).ident;
	...
	void paramTest15() throws PLPException {
		...
		assertEquals(1, v117.getNest());
		Declaration v118 = v117.getDec();
		...
		IToken v146 = v145.ident;
		assertEquals("p4", String.valueOf(v146.getText()));
		assertEquals(0, v145.getNest());
		Block v147 = v145.block;
		assertThat("", v147, instanceOf(Block.class));
		List<ConstDec> v148 = v147.constDecs;
		assertEquals(0, v148.size());
		List<VarDec> v149 = v147.varDecs;
		assertEquals(0, v149.size());
		List<ProcDec> v150 = v147.procedureDecs;
		assertEquals(0, v150.size());
		Statement v151 = v147.statement;
	...
	void paramTest16() throws PLPException {
		...
		IToken v42 = v41.ident;
		assertEquals("c", String.valueOf(v42.getText()));
		assertEquals(2, v41.getNest());
		List<ProcDec> v43 = v38.procedureDecs;
		assertEquals(0, v43.size());
		Statement v44 = v38.statement;
	...
	void paramTest17() throws PLPException {
		...
		assertEquals(3, v57.getNest());
		Declaration v58 = v57.getDec();
	...
	void paramTest19() throws PLPException {
		...
		assertEquals(2, v128.getNest());
		Declaration v129 = v128.getDec();
		IToken v130 = ((ConstDec) v129).ident;
		...
		assertEquals(2, v139.getNest());
		Declaration v140 = v139.getDec();
		...
		assertEquals(1, v163.getNest());
		Declaration v164 = v163.getDec();
		...
		assertEquals(1, v174.getNest());
		Declaration v175 = v174.getDec();
	...
	void paramTest20() throws PLPException {
		...
		assertEquals(1, v105.getNest());
		Declaration v106 = v105.getDec();
		...
		assertEquals(1, v116.getNest());
		Declaration v117 = v116.getDec();
	...
	void paramTest21() throws PLPException {
		...
		IToken v82 = v81.ident;
		assertEquals("p3", String.valueOf(v82.getText()));
		assertEquals(1, v81.getNest());
		Block v83 = v81.block;
		assertThat("", v83, instanceOf(Block.class));
		List<ConstDec> v84 = v83.constDecs;
		assertEquals(0, v84.size());
		List<VarDec> v85 = v83.varDecs;
		assertEquals(0, v85.size());
		List<ProcDec> v86 = v83.procedureDecs;
		assertEquals(0, v86.size());
		Statement v87 = v83.statement;
		...
		assertEquals(2, v111.getNest());
		Declaration v112 = v111.getDec();
		IToken v113 = ((ConstDec) v112).ident;
		...
		assertEquals("c", String.valueOf(v122.firstToken.getText()));
		assertEquals(2, v122.getNest());
		Declaration v123 = v122.getDec();
		IToken v124 = ((ConstDec) v123).ident;
		assertEquals("c", String.valueOf(v124.getText()));
		String v125 = (String) ((ConstDec) v123).val;
		assertEquals("a", v125);
		...
		Statement v138 = v20.statement;
		assertThat("", v138, instanceOf(StatementAssign.class));
		Ident v139 = ((StatementAssign) v138).ident;
		assertThat("", v139, instanceOf(Ident.class));
		assertEquals("d", String.valueOf(v139.firstToken.getText()));
		assertEquals(1, v139.getNest());
		Declaration v140 = v139.getDec();
